...
Webbplatsen simulerar en komplett digital närvaro för den frilansande konstnären **Marianne Sundberg (MaSu Studio)**. Lösningen fungerar som en kombinerad visuell portfölj, kommunikationskanal för utställningar samt en e-handelsplats för försäljning av originalkonst, reproduktioner (prints) och rekommenderat konstnärsmaterial.
